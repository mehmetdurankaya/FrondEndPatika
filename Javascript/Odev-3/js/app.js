...
// Kategori düğmelerini oluşturmak için map kullanımı
...
// Kategori düğmelerini DOM'a eklemek
categoryButtons.forEach((button) => {
  filterBtnContainer.appendChild(button);
});

// Menüyü kategoriye göre filtrelemek için reduce kullanımı
...
// Menüyü göstermek için bir işlev
...
// Kategori düğmelerine tıklama olayları eklemek için forEach kullanımı
categoryButtons.forEach((button) => {
  button.addEventListener("click", () => {
    ...
    if (category === "All") {
      ...
      displayMenuItems(menuByCategory[category]);
    }
  });
});
